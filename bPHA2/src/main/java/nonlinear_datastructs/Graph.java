...
public class Graph<T> implements Iterable<T> {
    ...
    public String toGraphviz() {
        ...
        for (T key : adjacencyList.keySet()) {
            ...
            for (T adjacent : getNeighbours(key)) {
                out.append(key.toString()).append(" -> ").append(adjacent.toString()).append('\n');
            }
        }
    ...
    public static final class DijkstraAlgorithm<T> {
         ...
         * non-negative edges.
         *
         * @param g     graph in which the shortest path is to be found from
         * @param start starting vertex to
         * @param end   ending vertex
         * @return      arrayList of vertices included in path
         * @param <T>   generic type
         */
        public static <T> ArrayList<T> dijkstra(Graph<T> g, T start, T end) {
            return null;
        }
    }
